  ...
  <div>
    ...
    <v-row justify="center" class="mt-3 mb-4">
      <v-text-field
        ...
        class="shrink mx-4"
      />
      <v-btn :color="type === warning ? 'yellow' : 'error'" rounded @click="searchData()">
      Search
      </v-btn><br><br>
    </v-row>
...
.theme--dark.v-application {
  background-image: url("https://2.bp.blogspot.com/-HHu4vj9z5uA/Urzsa-ILLPI/AAAAAAAAEV4/GpmcQy5bhvQ/s1600/Girls_und_Panzer_group_picture_wallpaper_Anglerfish_Anko_Angko_team_Mako_Reizei_Saori_Takebe_Miho_Nishizumi_Yukari_Akiyama_Hana_Isuzu_school_uniform_sitting_on_Panzer_4_turret.jpg");
